...
public class TestExample3 {
    ...
    private static int SEED2 = 28;
    private static int SEED3 = 5;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            MOBILE_CAN_BE_TURNED_OFF = Integer.parseInt(args[5]);
            ...
            Log.printLine("\n########  RESULTS  ########\n");
            Log.printLine("See Console output for results...");
            ...
            Log.printLine("\nControlled Devices: ");
            for (FogDevice controlledDevice : attacker.getControlledDeviceList()) {
                Log.print(controlledDevice.getMyId() + ", ");
            }
            Log.printLine();
            ...
            csvWriter.write(possibleWays.size() + ", " + averagePathLength + ", ");    // path information
    ...
    private static void setMobilityData(MobileDevice mobileDevice, LinkedList<Integer> precomputedPath) {
        ...
        for (int p : precomputedPath) {
            ...
            x = deviceMap.getFogDeviceList().get(p).getCoord().getCoordX();
            y = deviceMap.getFogDeviceList().get(p).getCoord().getCoordY();
...
//               FogDevice fogDevice = new FogDevice(name, coordX, coordY, id);
    ...
    public static void setAveragePathLength(double averagePathLength) {
        TestExample3.averagePathLength = averagePathLength;
    }

    public static void setSCENARIO(int SCENARIO) {
        TestExample3.SCENARIO = SCENARIO;
    }
