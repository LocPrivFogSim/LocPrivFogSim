...
public final class MaxAndMin {
	...
	public static final int AP_COVERAGE = 40; //Max Ap coverage distance - It should modify
	public static final int CLOUDLET_COVERAGE = 18; //Max Ap coverage distance - It should modify
	public static final int MAX_DISTANCE_TO_HANDOFF = 20; //It cannot be less than Max_SPEED
	...
	public static final int MAX_SIMULATION_TIME = 1000 * 60 * 30; // 1000 Ticks * 60 Seconds * 30 Minutes
