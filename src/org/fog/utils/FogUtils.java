...
public class FogUtils {
	...
	private static int ACTUAL_TUPLE_ID = 0;
	...
	public static void setTupleId(int tupleId) {
		TUPLE_ID = tupleId;
	}
	...
	public static void setActualTupleId(int actualTupleId) {
		ACTUAL_TUPLE_ID = actualTupleId;
	}
}
