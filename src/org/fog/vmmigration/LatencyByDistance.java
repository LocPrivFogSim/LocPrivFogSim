...
public class LatencyByDistance {
	...
	private static double latencyConnection(FogDevice sc1, FogDevice sc2){
		double distance = Distances.checkDistance(sc1.getPosition().getCoordinate(), sc2.getPosition().getCoordinate());
	...
	public static double latencyConnection(FogDevice sc, MobileDevice st){
		double distance = Distances.checkDistance(st.getPosition().getCoordinate(), st.getSourceAp().getPosition().getCoordinate());//bw ST and AP
