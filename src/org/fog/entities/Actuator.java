...
//									Log.printLine("st.getVmLocalServerCloudlet() NULL");
									st.getVmLocalServerCloudlet();
								}
							}
							else{
								//Log.printLine("st.getSourceAp().getServerCloudletToVmMigrate() NULL");
								st.getSourceAp().getServerCloudletToVmMigrate();
							}
						}
						else{
//							Log.printLine("GetSourceAP NULL");
							st.getSourceAp();
						}
					}
					else{
//						Log.printLine("st NULL");
						Log.printLine(st);;
					}
