...
//		ini = printTempo(ini, currentTime, "75 82 i");
		for (ResCloudlet rcl : getCloudletExecList()) {//////////////AQUI!!!!!!!!!
			...
			//Log.printLine(getTotalCurrentAllocatedMipsForCloudlet(rcl, getPreviousTime()));
			//OLA Log.printLine(CloudSim.clock()+ " : Remaining length of tuple ID "+((Tuple)rcl.getCloudlet()).getActualTupleId()+" = "+rcl.getRemainingCloudletLength());
