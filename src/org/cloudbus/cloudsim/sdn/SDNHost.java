...
*/
	...
	public void processEvent(SimEvent ev) {
		...
		switch(tag){
			...
			default: Log.printLine("Unknown event received by "+super.getName()+". Tag:"+ev.getTag());
		}
	}
	...
	private void processPackage(Package data) {
		...
		if (dstVm != null){//Try to deliver package to a hosted VM
			...
			Log.printLine("Warning package sent to wrong host. Host ID="+host.getId()+" DST VM ID="+vmId+", SRC VM ID="+data.getDestination());
		}
	}
