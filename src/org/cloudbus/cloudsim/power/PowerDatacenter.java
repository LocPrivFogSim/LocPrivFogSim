...
//			Log.printLine(CloudSim.clock()+" PowerDatacenter updateCloudletProcessing 95");
...
//			Log.printLine("99 src: "+getId()+" ev: "+ev.toString()+
//					" type: " + ev.getType() + " ev time: "+ ev.eventTime() +
//					" sched by: " + ev.scheduledBy() + " data :" + ev.getData());
//			Log.printLine("102 "+ CloudSim.getEntity(ev.getSource()).getName());
			return;
		}
...
//				Log.printLine(currentTime+" PowerDatacenter updateCloudletProcessing 150");
//				CloudSim.cancelAll(getId(), new PredicateType(CloudSimTags.VM_DATACENTER_EVENT));
				CloudSim.cancelAll(CloudSim.getEntity(getId()).getFutureQueue());
...
//				Log.printLine("158 src: "+getId()+" ev: "+ev.toString()+
//						" type: " + ev.getType() + " ev time: "+ ev.eventTime() +
//						" sched by: " + ev.scheduledBy() + " data :" + ev.getData());
//				Log.printLine("161 "+ CloudSim.getEntity(ev.getSource()).getName());
			}
			else{
//				Log.printLine(+currentTime+" minTime "+minTime);
			}
